...
**Implementiert (Slice 7.9):** root-only Backup-Befehl `vyntrio-backup`
(Service-Stop, SQLite-Dateisatz + `config.toml`-Companion, Manifest/SHA-256,
Ziel `/var/lib/vyntrio/backups/`, Post-Restart-Loopback-Readiness).
